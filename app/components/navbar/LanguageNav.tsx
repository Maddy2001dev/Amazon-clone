...
export default function LanguageNav() {
  ...
  const Modal = (
    <>
      <div className="absolute w-72 top-full -right-[calc(8rem-2px)] z-[51]">
        <div className="triangle absolute top-[-10px] left-1/2 -translate-x-1/2"></div>
  ...
  return (
    <div className="hidden sm: md:block lg:block relative">
      <div
        onMouseEnter={() => setShowModal(() => true)}
        onMouseLeave={() => setShowModal(() => false)}
        className=" mr-[5px] cursor-pointer flex items-end justify-center gap-1.6 p-1 hover:border-[1px] hover:rounded-sm border-[1px] border-nav hover:border-white ml-3"
      >
        <Image
          className="mt-1"
          src="/images/icons/united-states.png"
