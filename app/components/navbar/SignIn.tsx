...
export default function SignIn() {
  ...
  const Modal = (
    <>
      <div className="absolute top-[102%] w-max -right-[80px] z-[51]">
        <div className="triangle absolute top-[-10px] right-[80px]"></div>
  ...
  return (
    <div
      ...
      className="relative text-nowrap hidden sm:hidden md:block lg:block mr-1.4 p-1.6 cursor-pointer hover:border-[1px] hover:rounded-sm border-[1px] border-nav hover:border-white"
    >
